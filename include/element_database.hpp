#ifndef __SYMMETRY_ANALYZER_ELEMENTS_HPP__
#define __SYMMETRY_ANALYZER_ELEMENTS_HPP__
...
struct Element {
  Element(short atm, const std::string&, const std::string&, double, short,
  ...
  double valence;
  short valence_electrons;
  double covalent_radius;
  double vdW_radius;
  double metallic_radius;
};

Element::Element(short atm, const std::string& n, const std::string& fn,
		 double v, short ve, double cr, double vdwr, double mr)
    : atomic_number{atm},
      name{std::move(n)},
      full_name{std::move(n)},
      valence{v},
...
const std::set<Element> elements_list = {
    {1, "H", "Hydrogen", 1.0, 1, 0.31, 1.20, xtal_consts::FEMPTY},
    {2, "He", "Helium", 0.5, 2, 0.28, 1.40, xtal_consts::FEMPTY},
    {3, "Li", "Lithium", 1.0, 1, 1.28, 1.82, 1.52},
    {4, "Be", "Beryllium", 2.0, 2, 0.96, 1.53, 1.12},
    {5, "B", "Boron", 3.0, 3, 0.84, 1.92, xtal_consts::FEMPTY},
    {6, "C", "Carbon", 4.0, 4, 0.78, 1.70, xtal_consts::FEMPTY},
    {7, "N", "Nitrogen", 3.0, 5, 0.78, 1.55, xtal_consts::FEMPTY},
    {8, "O", "Oxygen", 2.0, 6, 0.70, 1.52, xtal_consts::FEMPTY},
    {9, "F", "Fluorine", 1.0, 7, 0.57, 1.47, xtal_consts::FEMPTY},
    {10, "Ne", "Neon", 0.5, 8, 0.58, 1.54, xtal_consts::FEMPTY},
    {11, "Na", "Sodium", 1.0, 1, 1.66, 2.27, 1.86},
    {12, "Mg", "Magnesium", 2.0, 2, 1.41, 1.73, 1.60},
    {13, "Al", "Aluminium", 3.0, 3, 1.21, 1.84, 1.43},
    {14, "Si", "Silicon", 4.0, 4, 1.11, 2.10, xtal_consts::FEMPTY},
    {15, "P", "Phosphorus", 3.0, 5, 1.07, 1.80, xtal_consts::FEMPTY},
    {16, "S", "Sulfur", 2.0, 6, 1.25, 1.80, xtal_consts::FEMPTY},
    {17, "Cl", "Chlorine", 1.0, 7, 1.02, 1.75, xtal_consts::FEMPTY},
    {18, "Ar", "Argon", 0.5, 8, 1.06, 1.88, xtal_consts::FEMPTY},
    ...
    {32, "Ge", "Germanium", 4.0, 4, 1.20, 2.11, xtal_consts::FEMPTY},
    {33, "As", "Arsenic", 3.0, 5, 1.19, 1.85, xtal_consts::FEMPTY},
    {34, "Se", "Selenium", 2.0, 6, 1.20, 1.90, xtal_consts::FEMPTY},
    {35, "Br", "Bromine", 1.0, 7, 1.20, 1.85, xtal_consts::FEMPTY},
    {36, "Kr", "Krypton", 0.5, 8, 1.16, 2.02, xtal_consts::FEMPTY},
    ...
    {50, "Sn", "Tin", 4.0, 4, 1.39, 2.06, xtal_consts::FEMPTY},
    {51, "Sb", "Antimony", 3.0, 5, 1.39, 2.06, xtal_consts::FEMPTY},
    {52, "Te", "Tellurium", 2.0, 6, 1.38, 2.06, xtal_consts::FEMPTY},
    {53, "I", "Iodine", 1.0, 7, 1.39, 1.98, xtal_consts::FEMPTY},
    {54, "Xe", "Xenon", 0.5, 8, 1.40, 2.16, xtal_consts::FEMPTY},
    ...
    {82, "Pb", "Lead", 4.0, 4, 1.46, 2.02, xtal_consts::FEMPTY},
    {83, "Bi", "Bismuth", 3.0, 5, 1.48, 2.07, xtal_consts::FEMPTY},
    {84, "Po", "Polonium", 2.0, 6, 1.40, 1.97, xtal_consts::FEMPTY},
    {85, "At", "Astatine", 1.0, 7, 1.50, 2.02, xtal_consts::FEMPTY},
    {86, "Rn", "Radon", 0.5, 8, 1.50, 2.20, xtal_consts::FEMPTY},
    {87, "Fr", "Francium", 1.0, 1, 2.60, 3.48, xtal_consts::FEMPTY},
    {88, "Ra", "Radium", 2.0, 2, 2.21, 2.83, xtal_consts::FEMPTY},
    {89, "Ac", "Actinium", 3.0, 3, 2.15, 2.20, xtal_consts::FEMPTY},
    ...
    {97, "Bk", "Berkelium", 4.0, 3, xtal_consts::FEMPTY, xtal_consts::FEMPTY,
     1.70},
    {98, "Cf", "Californium", 4.0, 3, xtal_consts::FEMPTY, xtal_consts::FEMPTY,
     1.86},
    {99, "Es", "Einsteinium", 4.0, 3, xtal_consts::FEMPTY, xtal_consts::FEMPTY,
     1.86},
    {100, "Fm", "Fermium", 4.0, 3, xtal_consts::FEMPTY, xtal_consts::FEMPTY,
     xtal_consts::FEMPTY},
    {101, "Md", "Mendelevium", 4.0, 3, xtal_consts::FEMPTY, xtal_consts::FEMPTY,
     xtal_consts::FEMPTY},
    {102, "No", "Nobelium", 4.0, 3, xtal_consts::FEMPTY, xtal_consts::FEMPTY,
     xtal_consts::FEMPTY},
    {103, "Lr", "Lawrencium", 4.0, 3, xtal_consts::FEMPTY, xtal_consts::FEMPTY,
     xtal_consts::FEMPTY},
    {104, "Rf", "Rutherfordium", 4.0, 3, xtal_consts::FEMPTY,
     xtal_consts::FEMPTY, xtal_consts::FEMPTY},
    {105, "Db", "Dubnium", 2.0, 3, xtal_consts::FEMPTY, xtal_consts::FEMPTY,
     xtal_consts::FEMPTY}};

const std::vector<std::array<double, 9>> sf = {
